package org.jboss.tools.benchmark.parsers.esprima;
 ...
 *
 */
public final class EsprimaParser {
    ...
    private void initParser(){
		...
		String esprimaPath = currentRelativePath.resolve("./esprima/parser.js").toAbsolutePath().toString();
		
        
		List<String> args = new ArrayList<String>();
		args.add(nodePath);
		args.add(esprimaPath);
